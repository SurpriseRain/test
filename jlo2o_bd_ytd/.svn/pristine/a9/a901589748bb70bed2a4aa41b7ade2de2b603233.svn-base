...
public class RetailInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the traceEvent value for this RetailInfo.
     * 
     * @return traceEvent
     */
    ...
    /**
     * Sets the traceEvent value for this RetailInfo.
     * 
     * @param traceEvent
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetailInfo)) return false;
        RetailInfo other = (RetailInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetailInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gs1cn.org", "RetailInfo"));
