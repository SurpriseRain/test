...
<div id="banner_main">
	<div id="pay">
		<div class="pay_main">
  			<div class="text">
  			   <span><img src="/customer/sydjt/images/gwc.png"></img></span>
    			<h4>购物车空空的哦~，去看看心仪的商品吧~ </h4>
    			<label><a href="/customer/sydjt/index.html">[ 去购物 ]</a></label>
  			</div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	$("#header").load("/customer/sydjt/head.jsp",function(reponse,status){
		if(status=="success"){
			$(".sy").css({"color":"#ff8800"});
		}
	});
