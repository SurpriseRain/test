...
public class ThreadRclTestByAsync implements IThreadRclWorkListener {
    ...
    public void test() {
        ...
        trws.doParallelWorkByAsync(this);

        System.out.println("其它工作开始执行");
        System.out.println("其它工作执行完毕");
    }

    public void onAllThreadWorkDone(String sProcName, java.sql.Date dRclRQ, String[] sGSIDAry) {
        System.out.println(sProcName + "所有工作全部执行完毕");
    }

    public static void main(String[] args) {
        new ThreadRclTestByAsync().test();
    }
}
