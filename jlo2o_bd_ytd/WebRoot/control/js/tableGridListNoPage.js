					 ...
					 $.each(DefStaPer.columnsArr,function(index,temp){
							...
							if(temp.type=="thcz"){
								...
								if(thsl<gmsl){
									...
									s+='<td><a href="javascript:void(0);" class="sq buttons"  name="" style="color:#999;">申请退货</a></td>';
								}
							}
							//关联商品
							if(temp.type=="glsp"){
							...
							//关联商品
							if(temp.type=="ckcm"){
								ckcm = temp.property+"_"+fieldValue;
								var valueTxt = eval("columnName."+ckcm);
								s += '<td class="case2"><input type="text" id="'+ckcm.property+'_code" /></td>';;
							}
							...
							//买家退单入库
							if(temp.type=="mjtd"){
								s += '<td><a href="javascript:void(0);"  style="text-align:center;" class="rpl operation" id="check" name="sh">扫码/导入</a></td>';
							}
							//点击操作
							if(temp.type=="ttttt"){
